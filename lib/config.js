...
// Optional explicit group assignments (canonical team name -> group letter).
// Leave empty to auto-derive groups from match data (API round strings like
// "Group A - 1"). Fill this in if you want groups to show BEFORE any group
// matches have been played. Example: { 'Spain': 'A', 'France': 'B' }
export const GROUPS = {};
...
export function roundFromApi(roundStr) {
  ...
  if (s.includes('3rd') || s.includes('third place')) return 'sf'; // knockout scoring
